...
test("rejects unsafe public bases and emits stable public HTTPS URLs", () => {
  ...
  assert.equal(buildRegionGeoDataArtifacts({ ...input, publicBase: "https://[2001:4860:4860::8888]/geodata" }).manifest.urls.ip, "https://[2001:4860:4860::8888]/geodata/cn/AppleProxyIPCurrent.dat");
});
