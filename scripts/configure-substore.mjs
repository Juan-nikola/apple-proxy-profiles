...
export function canonicalTaskCatalog(channel = "current") {
  ...
  const tasks = [
    ...
    configTask("v2rayn-singbox-windows", "v2rayn", "substore-config-generator.js", channel, "apple-proxy-v2rayn", "windows", "Apple-Proxy-v2rayN", { core: "singbox", region: "cn" }),
    configTask("v2rayn-singbox-macos", "v2rayn", "substore-config-generator.js", channel, "apple-proxy-v2rayn", "macos", "Apple-Proxy-v2rayN", { core: "singbox", region: "cn" }),
    configTask("v2rayn-xray-windows", "v2rayn", "substore-config-generator.js", channel, "apple-proxy-v2rayn", "windows", "Apple-Proxy-v2rayN", { core: "xray", region: "cn" }),
    configTask("v2rayn-xray-macos", "v2rayn", "substore-config-generator.js", channel, "apple-proxy-v2rayn", "macos", "Apple-Proxy-v2rayN", { core: "xray", region: "cn" }),
    ...
    configTask("incy-config-iphone", "incy", "incy-config-generator.js", channel, "apple-proxy-incy", "iphone", "INCY", { adblockMode: "off", format: "array", selectionMode: "both" }),
    configTask("incy-config-ipad", "incy", "incy-config-generator.js", channel, "apple-proxy-incy", "ipad", "INCY", { adblockMode: "off", format: "array", selectionMode: "both" }),
    configTask("incy-config-appletv", "incy", "incy-config-generator.js", channel, "apple-proxy-incy", "appletv", "INCY", { adblockMode: "off", format: "array", selectionMode: "both" }),
    configTask("incy-config-android", "incy", "incy-config-generator.js", channel, "apple-proxy-incy", "android", "INCY", { adblockMode: "off", format: "array", selectionMode: "both" }),
    configTask("incy-config-androidtv", "incy", "incy-config-generator.js", channel, "apple-proxy-incy", "androidtv", "INCY", { adblockMode: "off", format: "array", selectionMode: "both" }),
