...
1. 打开公开 Happ 助手：`https://juan-nikola.github.io/apple-proxy-profiles/current/happ/import.html`，按页面提示把路由/geodata Profile 安装进 Happ。它下载同一通道的 `geosite.dat`、`geoip.dat`，不含私密节点。
