...
const baseOptions = { output: "config", type: "collection", name: "clash-fixture", nodeSubscriptionUrl: "https://example.invalid/clash-nodes?key=TEST_ONLY_FIXTURE", channel: "current" };
