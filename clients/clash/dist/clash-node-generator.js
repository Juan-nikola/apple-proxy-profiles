...
`;
  ...
  function renderClashSubscription(nodes, options = {}) {
  ...
  async function operator(input, targetPlatform, context = {}) {
    ...
    const content = renderClashSubscription(normalized.nodes, { onDiagnostics(value) {
...
async function operator(input, targetPlatform) { return ClashNodeBundle.operator(input, targetPlatform, { arguments: $arguments, produceArtifact, logger: console }); }
