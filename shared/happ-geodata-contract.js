// Neutral Xray label contract shared by HAPP routing, DNS and GeoData builds.
export const HAPP_GEOSITE_ALIASES = Object.freeze({
  Hijacking: "CATEGORY-ADS-ALL", BlockHttpDNS: "CATEGORY-HTTPDNS-CN", Privacy: "PRIVATE",
  DomesticCore: "CN", DomesticGame: "CATEGORY-GAMES-CN", SteamCN: "STEAM",
  BiliBili: "BILIBILI", ByteDance: "BYTEDANCE", XiaoHongShu: "XIAOHONGSHU",
  Weibo: "CATEGORY-SOCIAL-MEDIA-CN", OpenAI: "OPENAI", Claude: "CATEGORY-AI-!CN",
  Gemini: "GOOGLE-GEMINI", Copilot: "GITHUB-COPILOT", GitHub: "GITHUB", YouTube: "YOUTUBE",
  Netflix: "NETFLIX", Disney: "DISNEY", Spotify: "SPOTIFY", GlobalMedia: "CATEGORY-MEDIA",
  Telegram: "TELEGRAM", Facebook: "FACEBOOK", Instagram: "INSTAGRAM", Twitter: "TWITTER",
  TikTok: "TIKTOK", Apple: "APPLE", Microsoft: "MICROSOFT",
  Download: "CATEGORY-NETDISK-!CN", PrivateTracker: "CATEGORY-PT",
  OverseasGame: "CATEGORY-GAMES-!CN", ChinaTLD: "CN",
});
...
export const HAPP_PROFILE_BLOCK_SITES = Object.freeze(["geosite:CATEGORY-ADS-ALL", "geosite:CATEGORY-HTTPDNS-CN"]);
