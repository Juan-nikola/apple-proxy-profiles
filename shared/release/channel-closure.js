...
function isNativeGeneratorPath(path) {
  return /^(?:(?:edge|current|previous)\/|versions\/[0-9a-f]{64}\/)?(?:clients\/[^/]+\/[0-9a-f]{64}\/)?(?:anywhere|egern|shadowrocket|sing-box|surge|v2box|v2rayn|clash|happ|incy|hiddify)\/scripts\/[^/]+\.js$/u.test(path);
}
