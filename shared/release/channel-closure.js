...
function isNativeGeneratorPath(path) {
  return /^(?:(?:edge|current|previous)\/|versions\/[0-9a-f]{64}\/)?(?:clients\/[^/]+\/[0-9a-f]{64}\/)?(?:anywhere|egern|happ|onexray|shadowrocket|sing-box|surge|v2rayn|v2box|clash)\/scripts\/[^/]+\.js$/u.test(path);
}
